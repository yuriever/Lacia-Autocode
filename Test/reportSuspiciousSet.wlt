...
VerificationTest[
	getSuspiciousSet[str_String] := Lacia`Autocode`reportSuspiciousSet`Private`postFormat[Lacia`Autocode`reportSuspiciousSet`Private`getSuspiciousSetFromAST[{}][CodeParse[str]]]
	,
	Null
	,
...
VerificationTest[
	Lacia`Autocode`reportSuspiciousSet`Private`getSuspiciousSetFromAST[{}][Lacia`Autocode`reportSuspiciousSet`Private`screenVerbatimPattern[CodeParse["HoldPattern[x_=y_]:>{x,y}"]]]
	,
	{{}, {{}, {}}, {}}
	,
