...
VerificationTest[
	Lacia`Autocode`dependency`Private`getRelationFromHeldSymbol[True, {}][Hold[a]]
	,
...
VerificationTest[
	Lacia`Autocode`dependency`Private`getRelationFromHeldSymbol[False, {}][Hold[a]]
	,
...
VerificationTest[
	Lacia`Autocode`dependency`Private`getEdgeFromDefinition[True, {}, 1][Hold[g]]
	,
	{}
	,
...
VerificationTest[
	Lacia`Autocode`dependency`Private`getEdgeFromDefinition[False, {}, 1][Hold[g]]
	,
